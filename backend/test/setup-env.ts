...
if (!process.env.DB_NAME) process.env.DB_NAME = 'huston-housing_test';
...
if (!process.env.HUSTON_HOUSING_CONTRACT_ID)
  process.env.HUSTON_HOUSING_CONTRACT_ID = E2E_CONTRACT_ID;
