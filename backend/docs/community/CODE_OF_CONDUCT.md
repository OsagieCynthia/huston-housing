...
Instances of abusive, harassing, or otherwise unacceptable behavior must be reported by contacting the project HR Lead or the core maintainers team. All complaints will be reviewed and investigated promptly and fairly.
...
All backend maintainers and core team members are required to undergo onboarding training which covers these expectations, inclusive code review practices, and effective communication.

## 9. Acknowledgment

By contributing to this project, you agree to abide by this Code of Conduct and its enforcement procedures.

## 10. Updates

This Code of Conduct is a living document. It will be reviewed and updated periodically to reflect our community's growth.

---

## Code of Conduct Checklist

- [ ] Ensure all communication uses respectful and clear language.
- [ ] Direct feedback at the code, not the developer.
- [ ] Involve mediators if a conflict cannot be resolved independently.
- [ ] Understand reporting procedures and consequences.
- [ ] Complete the code of conduct onboarding reading.
