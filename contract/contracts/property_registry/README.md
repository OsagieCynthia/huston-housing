...
The Houston Housing rental contract can be updated to query this registry before creating rental agreements:
...
This contract is part of the Houston Housing project.
